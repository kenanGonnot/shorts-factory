---
description: 'Implementing the solution as per the implementation plan'
---
Implements the following tasks:
* Read at the `implementation-plan.md` and `project.md` file to get insights on the task and start implementing the solution.
* If needed: Research online using `google-search` and `context7` to get more insights on the chosen solution.
...
* You’re working with Python 3.10 — please leverage its native typing features